	...
	$.ajax({url:'/addrole/',
		...
		success:function(data){
			...
			$.each(data,function(i,item){
				...
				html+='<tr id="roleinfo"><td width="200px;" id="rolename" align="center">'+dataObj.name+'</td><td width="200px" align="center">'+dataObj.description+'</td><td width="200px;" align="center" id="status">****</td><td width="200px;">'+dataObj.updatetime+'</td><td width="200px;"><img id="edit" width="10%" src="/js/edit.jpg"><span id="editbutton" style="display:none;cursor:pointer;">编辑角色</span>&nbsp;<img id="delete" width="11%" src="/js/delete.png"><span id="deletebutton" style="display:none;cursor:pointer;">删除角色</span></td></tr>'
			});
	...
	$("#addrole").find("#confirm").click(function(){
		...
		$.ajax({url:'/addrole/',
			...
			success:function(data){
				...
				$.each(data,function(i,item){
					var dataObj=eval("("+item+")");
					html+='<tr id="roleinfo"><td width="200px;" id="rolename" align="center">'+dataObj.name+'</td><td width="200px" align="center">'+dataObj.description+'</td><td width="200px;" align="center" id="status">****</td><td width="200px;">'+dataObj.updatetime+'</td><td width="200px;"><img id="edit" width="10%" src="/js/edit.jpg"><span id="editbutton" style="display:none;cursor:pointer;">编辑用户</span>&nbsp;<img id="delete" width="11%" src="/js/delete.png"><span id="deletebutton" style="display:none;cursor:pointer;">删除用户</span></td></tr>'
				});
				var head='<tr style="background-color:gray;"><td width="200px;" align="center">角色名称</td><td width="200px" align="center">角色描述</td><td width="200px;" align="center">所属用户</td><td width="200px;">创建时间</td><td width="200px;">操作</td></tr>';
				$('#rolelist').html(head+html);
...
$(".deleterole").mouseover(function(){
        ...
        $(this).css("border","1px solid black");
				...
				$(this).on("hover","#delete",function(e){
					 $(this).css("width","12%");
                        		 $(this).next().show();
				}),function(){
					$(this).css("width","10%");
